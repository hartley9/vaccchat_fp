...
function render() {
  ...
  if (frameCounter < frameLimit){
    ...
    frameCounter++;
		...
		let currentCanvas = document.getElementById('primaryCanvas');
	//	currentCanvas.setAttribute('hidden', 'hidden');

		//download_txt(JSON.stringify(currentData));
	}
}
...
field2D = function field2D(width, height) {
  ...
  this.canvas.setAttribute("id", "primaryCanvas")
...
field2D.prototype.draw = function() {
  ...
  ctx.drawImage(this.canvas, 
    ...
    //console.log("iamge data: ", this.imgdata);
  return this;
};
