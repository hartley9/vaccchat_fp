...
function build_maskMaterial(videoTransformMat2){
  ...
  */
    ...
    const vec2 TEARPOINT0 = vec2(-0.43,-0.85);\n\
    const vec2 DISPLACEMENT0 = vec2(-0.12,-0.75);\n\
    const float RADIUS0 = 0.1;\n\
    // deformation 2 parameters:\n\
    const vec2 TEARPOINT2 = vec2(-0.43, -0.365);\n\
    const vec2 DISPLACEMENT2 = vec2(-0.12,-0.365);\n\
